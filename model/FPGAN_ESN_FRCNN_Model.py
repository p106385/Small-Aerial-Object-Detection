...
# Taken from  BASICSR repository and modified
class FPGAN_ESN_FRCNN_Model(BaseModel):
    def __init__(self, config, device):
        super(FPGAN_ESN_FRCNN_Model, self).__init__(config, device)
        ...
        self.device = device
        #Generator
        self.netG = model.FPGAN_ESN(in_nc=self.configG['in_nc'], out_nc=self.configG['out_nc'],
        ...
        #num_classes = 2 # storage_tank and background
        #num_classes = 16 # dota_classes and background

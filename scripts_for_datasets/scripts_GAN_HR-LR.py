...
def generate_mod_LR_bic():
    ...
    sourcedir = '/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS'
    savedir = '/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS'
...
def copy_folder_name_for_valid_image():
    Dir_HR = "/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/"
    Dir_Bic = "/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/Bic/x4/"
    Dir_LR = "/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/LR/x4/"

    for file in glob.glob("/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved_FPGAN/val_images/*/"):
...
def merge_edge():
    dir = "/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved/val_images/*/*"
...
def calculate_psnr_ssim():
    dir = "/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved/"
    HR_DIR = "/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/valid_img/*"
    bicubic_DIR = "/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/Bic/x4/valid_img/*"
    ...
    text_file = open("/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved/Output_216000.txt", "a")
...
def calculate_psnr_ssim_FPGAN():
    dir = "/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved_FPGAN/val_images/*/*"
    HR_DIR = "/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/valid_img/"
    ...
    text_file = open("/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved_FPGAN/Output.txt", "a")
    print("SR PSNR: %4.2f"%avg_psnr_SR)
    text_file.write("SR PSNR: %4.2f \n"%avg_psnr_SR)
    print("SR SSIM: %5.4f"%avg_ssim_SR)
    text_file.write("SR SSIM: %5.4f \n"%avg_ssim_SR)
...
def separate_generated_image_for_test():
    dir = "/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved/val_images/*/*"
    dir_FPGAN = "/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved_EEGAN_separate/val_images/*/*"
    dir_save = "/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved/"

    img_final_SR = sorted(glob.glob(dir+'_216000_final_SR.png'))
    img_SR = sorted(glob.glob(dir+'_216000_SR.png'))
    #img_enhanced_SR = sorted(glob.glob(dir_FPGAN+'_400000_img_final_SR_enhanced.png'))
...
def calculate_lap_edge():
    HR_DIR = "/home/Usman/Super_Resolution/Datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/valid_img/*"
    dir_save = "/home/Usman/Super_Resolution/Filter_Enhance_Detect/saved/lap_edges_GT"
    img_GT = sorted(glob.glob(HR_DIR+'.jpg'))
    mean = np.array([0.3442, 0.3708, 0.3476])
    std = np.array([0.1232, 0.1230, 0.1284])
...
if __name__ == "__main__":
    ...
    #merge_edge()
    #calculate_psnr_ssim_FPGAN() #not working expected, use the other methods.

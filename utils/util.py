...
'''
cubic() method is taken from (BasicSR) GitHub Repo.
...
'''
calculate_weights_indices() method is taken (BasicSR) GitHub Repo.
...
'''
imresize_np() method is taken from (BasicSR) GitHub Repo.
Didn't go through the process of the methods. Take a look for good understanding.
Link: https://github.com/xinntuo/Basic_SR/blob/masteer/codes/data/util.py
'''

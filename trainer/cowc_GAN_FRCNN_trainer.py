...
import math
import os
import model.FPGAN_ESN_FRCNN_Model as FPGAN_ESN
from scripts_for_datasets import COWCDataset, COWCGANDataset
from scripts_for_datasets import DOTA_dataset
from scripts_for_datasets import OGST_dataset
...
class COWCGANFrcnnTrainer:
    ...
    def __init__(self, config, data_loader, valid_data_loader=None):
        ...
        self.model = FPGAN_ESN.FPGAN_ESN_FRCNN_Model(config,self.device)
